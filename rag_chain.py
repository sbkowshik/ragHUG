...
if the question is similar to "tell me more" or "Explain it" or "Explain more" or "summarize" refer to the recent input from the user in chat history for context retreival
